    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="laoshiId" name="laoshiId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="调课申请名称" prop="tiaokeName">
                       <el-input v-model="ruleForm.tiaokeName"
                                 placeholder="调课申请名称" clearable  :readonly="ro.tiaokeName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="调课申请名称" prop="tiaokeName">
                           <el-input v-model="ruleForm.tiaokeName"
                                     placeholder="调课申请名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="调课申请详情" prop="tiaokeContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.tiaokeContent" label="调课申请详情" prop="tiaokeContent">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.tiaokeYesnoTypes" label="审核状态" prop="tiaokeYesnoTypes">
                        <el-input v-model="ruleForm.tiaokeYesnoValue" placeholder="审核状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   tiaokeName: [
                              { required: true, message: '调课申请名称不能为空', trigger: 'blur' },
                          ],
                   tiaokeContent: [
                              { required: true, message: '调课申请详情不能为空', trigger: 'blur' },
                          ],
                   tiaokeYesnoTypes: [
