    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info' && sessionTable !='yonghu'"  label="作业得分" prop="huidaDefen">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && sessionTable !='yonghu'"  label="批改意见" prop="huidaContent">
